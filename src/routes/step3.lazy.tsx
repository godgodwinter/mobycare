...
export const Route = createLazyFileRoute('/step3')({
  component: Index,
})
...
import Splash from '@/assets/mobycare/splash_2.png'
const LoginPages = ()=>{
  return(
    <>
...
<div className="flex items-center justify-between mt-4  pt-10 py-2">
         ...
         <Link to="/step2" className="ms-4 inline-flex items-center px-4 py-2 bg-[#2F5BA8] border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-800 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                 BACK
              </Link>{' '}
              <Link to="/step4" className="ms-4 inline-flex items-center px-4 py-2 bg-[#f84525] border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-800 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                 Next
              </Link>{' '}
         </div>
